...
public class SentenceSegmenter {
		...
		try {
			...
			while ((line = inputData.readLine()) != null) {
				...
				for (Pair<Integer, Integer> point : points) {
					double partLL = parser.getSentenceProbability(point
							.getFirst(), point.getSecond(), opts.constituent);
	...
	public static void writeTreeToImage(Tree<String> tree, String fileName)
		...
		Rectangle2D.Double rect = new Rectangle2D.Double(0, 0, tjp.width(), tjp
				.height());
		g2.fill(rect);
