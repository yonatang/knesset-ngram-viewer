...
public class StateSet {
   ...
   //@@YG new
   public short initialSubstate=-1;
   ...
   //@@YG new
	public StateSet(short state, short nSubStates, short initialSubstate) {
		this.numSubStates = nSubStates;
		this.state = state;
   ...
   //@@YG new
	public StateSet(short s, short nSubStates, String word, short from, short to, short initialSubstate) {
		this.numSubStates = nSubStates;
		this.state = s;
		this.word = word;
		this.from = from;
   ...
   //@@YG new
	public StateSet(StateSet oldS, short nSubStates, short initialSubstate) {
      this(oldS, nSubStates);
      this.initialSubstate=initialSubstate;
	}
